...
post1 = Post.create({ title: "New user here", body: "Hi, I'm new here!", user_id: 5, group_id: 1, username: "qwepoi" })
...
post5 = Post.create({ title: "Vue Components", body: "In many Vue projects, global components will be defined using Vue.component, followed by new Vue({ el: '#container' }) to target a container element in the body of every page. Or we can use single-file components", user_id: 3, group_id: 2, username: "92837512" })
